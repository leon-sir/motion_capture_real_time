...
{
    ros::init(argc, argv, "accel_echo_transformed");
    ros::NodeHandle nh;
    
    printf("Listening to /vrpn_client_node/Rigid/accel ...\n");
    printf("Transform: (x, y, z) -> (x, -z, y)\n");
    
    ros::Subscriber sub = nh.subscribe("/vrpn_client_node/Rigid/accel", 10, accelCallback);
